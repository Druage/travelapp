...
import {CurrencyDollarIcon, MapIcon, MenuIcon, XIcon} from '@heroicons/react/outline'
        ...
        <div className="h-screen flex bg-gray-50 overflow-hidden">
                            ...
                            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                                <a href="#" className="flex-shrink-0 group block">
                                    <div className="flex items-center">
                                        <div>
                                            <img className="inline-block h-10 w-10 rounded-full" src={user.imageUrl}
                                                 alt=""/>
                                        </div>
                                        <div className="ml-3">
                                            <p className="text-base font-medium text-gray-700 group-hover:text-gray-900">{user.name}</p>
                                            <p className="text-sm font-medium text-gray-500 group-hover:text-gray-700">Account
                                                Settings</p>
                                        </div>
                                    </div>
                                </a>
            ...
            <div className="hidden lg:flex lg:flex-shrink-0">
                <div className="flex flex-col w-20">
                    <div className="flex flex-col h-0 flex-1 overflow-y-auto bg-gray-100">
                        <div className="flex-1 flex flex-col">
                            <div className="flex-shrink-0 bg-gray-500 py-4 flex items-center justify-center">
                            ...
                            <nav aria-label="Sidebar" className="py-6 flex flex-col items-center space-y-3">
                                {navigation.map((item) => (
                                    <Link
                                        key={item.name}
                                        to={item.href}
                                        className="flex items-center p-4 rounded-lg text-gray-800 hover:bg-gray-300"
                                    >
